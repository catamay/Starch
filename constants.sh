...
readonly PACKAGES_STANDARD='base linux base-devel glew libmad libjpeg libxinerama libpulse libpng libvorbis libxrandr libva mesa cmake ninja meson sfml git yasm xorg-xinit xorg-server vim dhcpcd alsa-utils lz4'
